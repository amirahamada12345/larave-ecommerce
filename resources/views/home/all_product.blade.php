...
<div style="text-align: center">
   ...
   <form action="{{url('add_comment')}}" method="Post">
      ...
      @csrf
      <textarea name="comment" cols="30" rows="10"  style="height: 150px;width:600px;" placeholder="comment some thing here"></textarea>
     <br>
...
<input type="text" id="commentId" name="commentId" hidden="">
      <textarea style="height: 100px;width:500px;" name="reply" placeholder="write some thing here"></textarea>
      <br>
